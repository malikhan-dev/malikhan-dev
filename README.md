...
**Lingo** is a Go DSL inspired by the LINQ philosophy that provides expressive querying capabilities for slices and collections, with streaming capabilities and more importantly its compiled streams engines you can rely on lingo for heavy duties and large data's.
